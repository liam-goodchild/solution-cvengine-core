...
- Design advanced CI/CD pipelines in Azure DevOps and GitHub Actions, ensuring linting, testing, security scanning, and deployment all run before anything hits an environment.
- DevSecOps approach, shifting security left so issues surface early rather than in production.
- Write architectural design documents and low-level designs for stakeholders, with clear business justifications for technical decisions.
- Work across the full breadth of Azure services, picking the right tool for the job rather than defaulting to what's familiar.
...
- Provided 3rd line support and incident management (24/7 on-call) across large Windows and Linux estates.
...
- Built an onboarding programme for new IT staff that cut ramp-up time significantly.
